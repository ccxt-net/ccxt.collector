...
{
    /// <summary>
    /// Test suite for Huobi exchange WebSocket integration
    /// </summary>
    [Collection("Exchange Tests")]
    [Trait("Category", "Exchange")]
    [Trait("Exchange", "Huobi")]
    public class HuobiTests : WebSocketTestBase
    {
        private readonly ExchangeTestFixture _fixture;

        public HuobiTests(ITestOutputHelper output, ExchangeTestFixture fixture) 
            : base(output, "Huobi")
        {
            _fixture = fixture;
            _testSymbols.Clear();
            _testSymbols.AddRange(_fixture.GetTestSymbols("Huobi"));
        }
        ...
        public async Task Huobi_WebSocket_Connection()
        {
            await TestWebSocketConnection();
            _fixture.MarkExchangeTested("Huobi", true);
        }

        [Fact]
        [Trait("Type", "DataStream")]
        public async Task Huobi_Orderbook_Stream()
        {
        ...
        [Fact]
        [Trait("Type", "DataStream")]
        public async Task Huobi_Trade_Stream()
        {
        ...
        [Fact]
        [Trait("Type", "DataStream")]
        public async Task Huobi_Ticker_Stream()
        {
        ...
        public async Task Huobi_Multiple_Subscriptions()
        {
