...
{
    /// <summary>
    /// Test suite for Upbit exchange WebSocket integration
    /// </summary>
    [Collection("Exchange Tests")]
    [Trait("Category", "Exchange")]
    [Trait("Exchange", "Upbit")]
    [Trait("Region", "Korea")]
    public class UpbitTests : WebSocketTestBase
    {
        private readonly ExchangeTestFixture _fixture;

        public UpbitTests(ITestOutputHelper output, ExchangeTestFixture fixture) 
            : base(output, "Upbit")
        {
            _fixture = fixture;
            _testSymbols.Clear();
            _testSymbols.AddRange(_fixture.GetTestSymbols("Upbit"));
        }

        protected override IWebSocketClient CreateClient()
        {
            return new UpbitWebSocketClient();
        }
        ...
        public async Task Upbit_WebSocket_Connection()
        {
            await TestWebSocketConnection();
            _fixture.MarkExchangeTested("Upbit", true);
        }

        [Fact]
        [Trait("Type", "DataStream")]
        public async Task Upbit_Orderbook_Stream()
        {
        ...
        [Fact]
        [Trait("Type", "DataStream")]
        public async Task Upbit_Trade_Stream()
        {
        ...
        [Fact]
        [Trait("Type", "DataStream")]
        public async Task Upbit_Ticker_Stream()
        {
        ...
        public async Task Upbit_Multiple_Subscriptions()
        {
