...
namespace CCXT.Collector.Bithumb
{
    public partial class Processing
    {
        ...
        private async Task publishOrderbook(SOrderBooks sob)
        {
            ...
            __orderbook.Write(this, BTConfig.DealerName, _json_data);
        }
        ...
        private async Task publishTrading(SCompleteOrders sco)
        {
            ...
            __trading.Write(this, BTConfig.DealerName, _json_data);
        }
        ...
        private async Task publishTicker(STickers stk)
        {
            ...
            __ticker.Write(this, BTConfig.DealerName, _json_data);
        }
