...
namespace CCXT.Collector.ItBit
{
    public partial class Processing
    {
        ...
        private async Task publishOrderbook(SOrderBooks sob)
        {
            ...
            __orderbook.Write(this, IBConfig.DealerName, _json_data);
        }
        ...
        private async Task publishTrading(SCompleteOrders sco)
        {
            ...
            __trading.Write(this, IBConfig.DealerName, _json_data);
        }
        ...
        private async Task publishTicker(STickers stk)
        {
            ...
            __ticker.Write(this, IBConfig.DealerName, _json_data);
        }
