...
Write-Host ""
Write-Info "========================================="
Write-Info "  CCXT.Collector NuGet Package Publisher"
Write-Info "========================================="
Write-Host ""
...
if (-not $SkipTests) {
    ...
    $TestPath = Join-Path $RootDir "tests\CCXT.Collector.Tests.csproj"
...
if ($DryRun) {
    ...
    Write-Success "========================================="
    Write-Host ""
    Write-Info "Package URL: https://www.nuget.org/packages/ccxt.collector/"
